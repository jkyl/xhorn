...
def bitslip(r,core,regname='adc5g_controller'):
    reg_val = 0xffffffff#1<<(28+core)
    reg_val_str = struct.pack('>L',reg_val)
    reset_val_str = struct.pack('>L',0)
    r.blindwrite(regname,reg_val_str,offset=6*4)
    r.blindwrite(regname,reset_val_str,offset=6*4)

def strobe_glitches(d):
    data = np.array(d)
    not_zero = data[data!=0]
    not_one_or_zero = not_zero[not_zero!=255]
    return len(not_one_or_zero)
...
for delay in range(DELAY_RANGE):
    ...
    for core in range(CORES):
        for bit in range(BITS):
            glitches[core,bit,delay] = strobe_glitches(test_vec[core])
...
#
#
set_io_delay(r,0,0,19,bit=0)
set_io_delay(r,0,0,20,bit=1)
set_io_delay(r,0,0,18,bit=2)
set_io_delay(r,0,0,18,bit=3)
set_io_delay(r,0,0,20,bit=4)
set_io_delay(r,0,0,18,bit=5)
set_io_delay(r,0,0,20,bit=6)
set_io_delay(r,0,0,20,bit=7)


set_io_delay(r,0,1,18,bit=0)
set_io_delay(r,0,1,18,bit=1)
set_io_delay(r,0,1,18,bit=2)
set_io_delay(r,0,1,18,bit=3)
set_io_delay(r,0,1,18,bit=4)
set_io_delay(r,0,1,20,bit=5)
set_io_delay(r,0,1,18,bit=6)
set_io_delay(r,0,1,18,bit=7)

set_io_delay(r,0,2,19,bit=0)
set_io_delay(r,0,2,17,bit=1)
set_io_delay(r,0,2,18,bit=2)
set_io_delay(r,0,2,18,bit=3)
set_io_delay(r,0,2,18,bit=4)
set_io_delay(r,0,2,20,bit=5)
set_io_delay(r,0,2,16,bit=6)
set_io_delay(r,0,2,18,bit=7)

set_io_delay(r,0,3,18,bit=0)
set_io_delay(r,0,3,16,bit=1)
set_io_delay(r,0,3,16,bit=2)
set_io_delay(r,0,3,16,bit=3)
set_io_delay(r,0,3,16,bit=4)
set_io_delay(r,0,3,17,bit=5)
