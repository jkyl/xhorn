...
if __name__ == '__main__':
    ...
    p.add_option('-r', '--roach', dest='roach',type='str', default='128.135.52.192', 
        help='ROACH IP address or hostname. Default: 128.135.52.192')
    ...
    #p.add_option('-a', '--acc_len', dest='acc_len',type='int', default='8388608', 
    #    help='Number of spectra to accumulate. Default: 8388608')
    p.add_option('-t', '--tvg', dest='tvg',action='store_true', default=False, 
        help='Use corner turn tvg. Default:False')
    p.add_option('-u', '--update', dest='update',action='store_true', default=True, 
        help='Auto update plot. Default:True')
